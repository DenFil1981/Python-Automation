...
class DataFild:
    @allure.step("Заходим в браузер по ссылке ")
    def __init__(self, browser) -> None:
        self.browser = browser
    
    @allure.step("Находим поля для заполнения ")    
    def find_fields(self):
        self.class_first_name = (By.ID, "first_name")  
        self.class_last_name = (By.ID, "last_name")
        self.class_aadress = (By.ID, "aadress")
    ...
    @allure.step("Проверяем результат и проверяем")   
